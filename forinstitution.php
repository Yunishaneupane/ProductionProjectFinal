...
<head>
  ...
  <title>For Institutions - EduPath</title>
  <link rel="stylesheet" href="forinstitution.css" />
...
<section class="institutions-hero">
  <div class="institutions-left">
    ...
    <a href="contactus.php" class="cta-btn">Get in touch</a>
  </div>
  <div class="institutions-right">
  
    <img src="images/institution.jpg" alt="Institution Image" />
  </div>
</section>

<!-- SERVICES SECTION -->
<section class="institution-services">
  <div class="service-card">
    <img src="images/stdrec.png" alt="Recruitment Image" />
  ...
  <div class="service-card highlighted">
    <img src="images/datain.jpg" alt="Data Insights" />
    <div class="service-content">
      <h3>Data & Insights</h3>
  ...
  <div class="service-card">
    <img src="images/consult.jpg" alt="Consulting Image" />
    <div class="service-content">
      <h3>Consulting</h3>
